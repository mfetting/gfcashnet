...
// entry meta keys
const META_UNIQUE_ID 		= 'gfcashnet_unique_id';	// unique form submission
const META_TRANSACTION_ID 	= 'gfcashnet_txn_id';		// merchant's transaction ID (invoice number, etc.)

// end points for return to website
const ENDPOINT_RETURN		= '__gfcashnetreturn';

/**
* custom exception types
*/
class GFcashnetException extends Exception
{}
